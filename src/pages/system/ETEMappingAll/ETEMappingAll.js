  ...
  return (
    ...
    >
      ...
      <div className="container">
        <div className="row">
          <div
            className="col-md-4 mb-4 cursor-pointer"
            onClick={() => setPage('/eteMapping', 'Loan Product')}
          >
          ...
          <div
            className="col-md-4 mb-4 cursor-pointer"
            onClick={() => setPage('/eteMapping', 'Saving Product')}
          >
            <div className="ete_object bg-white py-4 px-3">
              <div className="d-flex">
                <h6>Offices</h6>
          ...
          <div
            className="col-md-4 mb-4 cursor-pointer"
            onClick={() => setPage('/eteMapping', 'Charges / Fees')}
          >
            <div className="ete_object bg-white py-4 px-3">
              <div className="d-flex">
                <h6>Offices</h6>
