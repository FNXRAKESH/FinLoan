...
import './EmailServicesTable.scss';
...
const EmailServicesTable = () => {

  let history = useHistory();

  const items = [{Name: 'username', Value: 'support@'},
  ...
  return (
      ...
      >
        ...
        <div className="d-flex mb-2">
              ...
              >
                <motion.div
                  className="edit-EmailServicesTable mt-2 d-flex"
                  style={{cursor: 'pointer'}}
                  initial={{ opacity: 0, y: 30 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: 0.8 }}
                  onClick={()=>{history.push('/emailservices')}}
                >
...
export default EmailServicesTable;
