...
const ImportFixedDepositAccounts = () => {
  ...
  return (
    <div id="importFixedDepositAccounts" className="pl-5">
      <h5 className="py-3">Import Fixed Deposit Accounts</h5>
      <motion.div
      ...
      >
        <div className="import w-100 mb-5">
          <Form>
            <h6>Fixed Deposit Account Template</h6>
            <Row>
              <Col md >
...
export default ImportFixedDepositAccounts;
