...
const ImportLoanAccounts = () => {
  ...
  return (
    <div id="importLoanAccounts" className="pl-5">
      <h5 className="py-3">Import Loan Accounts</h5>
      <motion.div
...
export default ImportLoanAccounts;
