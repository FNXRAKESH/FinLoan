...
const ImportShareAccounts = () => {
  ...
  return (
    <div id="importShareAccounts" className="pl-5">
      <h5 className="py-3">Import Share Accounts</h5>
      <motion.div
...
export default ImportShareAccounts;
