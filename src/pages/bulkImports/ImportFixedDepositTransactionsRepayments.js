...
const ImportFixedDepositTransactionsRepayments = () => {
  ...
  return (
    <div id="importFixedDepositTransactionsRepayments" className="pl-5">
      <h5 className="py-3">Import Fixed Deposit Transactions Repayments</h5>
      <motion.div
      ...
      >
        <div className="import w-100 mb-5">
          <Form>
            <h6>Fixed Deposit Transaction Template</h6>
            <Row>
              <Col md >
...
export default ImportFixedDepositTransactionsRepayments;
