...
const ImportLoanRepayments = () => {
  ...
  return (
    <div id="importLoanRepayments" className="pl-5">
      <h5 className="py-3">Import Loan Repayments</h5>
      <motion.div
...
export default ImportLoanRepayments;
