...
const ImportRecurringDepositAccounts = () => {
  ...
  return (
    <div id="importRecurringDepositAccounts" className="pl-5">
      <h5 className="py-3">Import Recurring Deposit Accounts </h5>
      <motion.div
      ...
      >
        <div className="import w-100 mb-5">
          <Form>
            <h6>Recurring Deposit Account Template</h6>
            <Row>
              <Col md >
            ...
            <hr />
            <h6>Recurring Deposit Accounts</h6>
            <p>
              Select Excel File
              {/* <small>{' '}
...
export default ImportRecurringDepositAccounts;
