...
const ImportRecurringDepositTransactions = () => {
  ...
  return (
    <div id="importRecurringDepositTransactions" className="pl-5">
      <h5 className="py-3">Import Recurring Deposit Transactions </h5>
      <motion.div
      ...
      >
        <div className="import w-100 mb-5">
          <Form>
            <h6>Recurring Deposit Transaction Template</h6>
            <Row>
              <Col md >
            ...
            <hr />
            <h6>Recurring Deposit Transactions</h6>
            <p>
              Select Excel File
              {/* <small>{' '}
...
export default ImportRecurringDepositTransactions;
