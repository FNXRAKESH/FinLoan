...
const ImportSavingsTransactionsRepayments = () => {
  ...
  return (
    <div id="importSavingsTransactionsRepayments" className="pl-5">
      <h5 className="py-3">Import Savings Transactions Repayments</h5>
      <motion.div
      ...
      >
        <div className="import w-100 mb-5">
          <Form>
            <h6>Savings Transaction Template</h6>
            <Row>
              <Col md >
...
export default ImportSavingsTransactionsRepayments;
