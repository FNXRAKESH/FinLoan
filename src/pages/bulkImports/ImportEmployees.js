...
const ImportEmployee = () => {
  ...
  return (
    <div id="importEmployee" className="pl-5">
      ...
      >
        <div className="import w-100 mb-5">
          <Form>
            ...
            {/* <div className="d-flex flex-wrap justify-content-between downloadFile">
              <div ><img className="excelLogo" src={excel}/> Office Template.xls</div>
              <div className="downloadLogo" ><img src={download}/>Download</div>
            </div> */}
            <Row>
              <Col md >
