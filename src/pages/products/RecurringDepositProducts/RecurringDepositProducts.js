...
const RecurringDepositProducts = () => {
  ...
  return (
    <div id="RecurringDepositProducts" className="pl-5">
      <div className="py-3 row d-flex">
        <h5 className="col-md-6 mt-3 mb-4">Recurring Deposit Products</h5>

        <div className="col-md-6 mt-3 d-flex justify-content-end">
          <motion.button
            className="create-rdp py-2 px-3"
                ...
                <tbody id="table-body" className="mt-3 pt-4">
                  {users.map((user) => (
                    <tr>
                      ...
                      <td className="py-3 text-right">{user.Shortname}</td>
