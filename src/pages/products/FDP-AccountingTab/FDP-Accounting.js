  ...
  return (
      ...
      >
        ...
        >
          ...
          >
            <div className="FDP-Accounting-checkbox-container">
              <Checkboxes />
            </div>
            ...
            <form>
              <div className="container">
                ...
                <div style={{fontSize: '20px'}}>
                  ...
                  <div className="my-2" style={{fontSize: '20px'}}>
                    ...
                    <div class="custom-control custom-switch">
                      ...
                      <label class="custom-control-label FDP-Accounting-text-small" for="customSwitch1">
                  ...
                  <div class="custom-control custom-switch mb-5">
                    ...
                    <label class="custom-control-label FDP-Accounting-text-small" for="customSwitch2">
                ...
                <div>
                  <div class="custom-control custom-switch my-2">
                    ...
                    <label class="custom-control-label FDP-Accounting-text-small" for="customSwitch3">
                      Map Fees to Income Accounts
                    </label>
                  </div>
                  <div class="custom-control custom-switch my-2">
                    <input type="checkbox" class="custom-control-input" id="customSwitch4" />
                    <label class="custom-control-label FDP-Accounting-text-small" for="customSwitch4">
              ...
              <div className="container">
                <div 
                  className="FDP-Accounting-btn-section my-5 w-100"
                >
                  <Button 
...
export default FDP_AccountingTab;
