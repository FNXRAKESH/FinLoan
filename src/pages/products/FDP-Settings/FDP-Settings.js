...
const FDP_Settings = () => {
  ...
  function goto_IRC() {
    if (lck_in == ''){
      localStorage.setItem('FDP-settings-error', 'true');
      history.push('/fdp-interest-rate-chart');
    }
    else{
      localStorage.removeItem('FDP-settings-error', 'true');
      history.push('/fdp-interest-rate-chart');
    }  
  }
  ...
  return (
      ...
      >
        ...
        >
          ...
          >
            <div className="FDP-Settings-checkbox-container">
            <Checkboxes />
            </div>
            ...
            <form>
              <div className="container">
                ...
                <div style={{fontSize: '20px'}}>
                  ...
                  <div class="custom-control custom-switch mb-4">
                    ...
                    <label class="custom-control-label FDP-Settings-text-small" for="customSwitch4">Apply penal interest (less)</label>
                  </div>
                ...
                <div>
                  ...
                  <div class="custom-control custom-switch mb-4">
                    ...
                    <label class="custom-control-label FDP-Settings-text-small" for="customSwitch5">Is Withold tax applicable</label>
                  </div>
              ...
              <div className="container">
                <div 
                  className="FDP-Settings-btn-section my-5 w-100"
                >
                  <Button 
                    onClick={goto_terms}
