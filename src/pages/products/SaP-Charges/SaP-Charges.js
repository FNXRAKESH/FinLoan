...
const SaP_Charges = () => {
  ...
  function goto_accounting() {
    if (charges == '') {
      localStorage.setItem('SaP-charges-error', 'true');
      history.push('/sap-accountingTab');
    }
    else{
      localStorage.removeItem('SaP-charges-error');
      history.push('/sap-accountingTab');
    }
  }
...
return (
      ...
      >
        ...
        >
          ...
          >
            <div className="SaP-Charges-checkbox-container">
              <Checkboxes />
            </div>
            ...
            <form>
              <div className="container">
                ...
                <div className="SaP-Charges-input-section my-4 py-4 ">
                  ...
                  <div className="SaP-Charges-tags-div d-flex mx-3 pb-2 overflow-auto">
                    {[...tags_set].map((entry) => (
                      <div
                        className="SaP-Charges-tag pt-2 px-2 d-flex mr-3 align-items-center"
                      >
              ...
              <div className="container">
                <div 
                  className="SaP-Charges-btn-section my-5 w-100"
                >
                  <Button 
                    onClick={goto_IRC}
