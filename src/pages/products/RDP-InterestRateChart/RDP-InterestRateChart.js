...
const RDP_InterestRateChart = () => {
  ...
  return (
    <div id="RDP_InterestRateChart" className="pl-5">
      <div className="create_IRC">
        <h5 className="py-3">Create Recurring Deposit Products</h5>
        ...
        >
          ...
          <form>
            <div className="container">
              ...
              <div style={{ fontSize: '20px' }}>
                <div class="custom-control custom-switch mb-4">
                  ...
                  />
                  <label
                    class="custom-control-label RDP-Settings-text-small"
                    for="customSwitch4"
                  >
            ...
            <div className="container">
              <div className="RDP-IRC-btn-section my-5 w-100">
                <Button
