...
const SP_Charges = () => {
  ...
  function goto_accounting() {
    if (charges == '') {
      localStorage.setItem('SP-charges-error', 'true');
      history.push('/sp-accountingTab');
    }
    else{
      localStorage.removeItem('SP-charges-error');
      history.push('/sp-accountingTab');
    }
  }
...
return (
      ...
      >
        ...
        >
          ...
          >
            <div className="SP-Charges-checkbox-container">
              <Checkboxes />
            </div>
            ...
            <form>
              <div className="container">
                ...
                <div className="SP-Charges-input-section my-4 py-4 ">
                  ...
                  <div className="SP-Charges-tags-div d-flex mx-3 pb-2 overflow-auto">
                    {[...tags_set].map((entry) => (
                      <div
                        className="SP-Charges-tag pt-2 px-2 d-flex mr-3 align-items-center"
                      >
              ...
              <div className="container">
                <div 
                  className="SP-Charges-btn-section my-5 w-100"
                >
                  <Button 
                    onClick={goto_MP}
