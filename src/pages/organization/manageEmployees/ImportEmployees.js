...
import importEmployees from '../../../images/downloadIcon.png';
...
const ImportEmployees = () => {
  ...
  return (
    <div id="importEmployees" className="pl-5">
      <h5 className="py-3">Import Employees</h5>
      <motion.div
      ...
      >
        <div className="import w-100 mb-5">
          <Form>
            <h6>Employee Template</h6>
            <div className="d-md-flex align-items-end">
              <div>
                <Form.Group controlId="posting.currency" className="m-0">
              ...
              <div
                className="d-flex align-items-center addEmployees mx-3"
                 
              >
                <img src={importEmployees} alt="import Employees" />
                <p className="m-0 pl-2">Download</p>
              </div>
            </div>

            <h6 className='mt-5'>Import Employees</h6>
